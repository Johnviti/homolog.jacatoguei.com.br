<?php
	...
	function welcome_mail($email,$pass) {
		...
		if( html_mail( $email,"Bem vindo ao jacataloguei!",$msg ) ) {
...
// cadastro simplificado
	...
	function edit_estabelecimento( 
		...
		$updatedquery = "UPDATE estabelecimentos SET 
			...
			pagamento_mercadopago_pix = '$pagamento_mercadopago_PIX',
            pagamento_mercadopago_pix_token = '$pagamento_mercadopago_pix_token',
	...
	function new_produto( $estabelecimento,$categoria,$destaque,$estoque,$posicao,$ref,$nome,$descricao,$valor,$oferta,$valor_promocional,$variacao,$status,$visible,$integrado ) {
		...
		if( mysqli_query( $db_con, "INSERT INTO produtos (rel_estabelecimentos_id,rel_categorias_id,destaque,estoque,posicao,ref,nome,descricao,valor,oferta,valor_promocional,variacao,status,visible,created,last_modified,integrado) VALUES ('$estabelecimento','$categoria','$destaque','$estoque','$posicao','$ref','$nome','$descricao','$valor','$oferta','$valor_promocional','$variacao','$status','$visible','$datetime','$datetime','$integrado');") ) {
	...
	function edit_produto( $id,$estabelecimento,$categoria,$destaque,$estoque,$posicao,$ref,$nome,$descricao,$valor,$oferta,$valor_promocional,$variacao,$status,$visible,$integrado ) {
		...
		$updatedquery = "UPDATE produtos SET rel_estabelecimentos_id = '$estabelecimento',rel_categorias_id = '$categoria',ref = '$ref',nome = '$nome',estoque = '$estoque',posicao = '$posicao',descricao = '$descricao',valor = '$valor',oferta = '$oferta',valor_promocional = '$valor_promocional',variacao = '$variacao',status = '$status',visible = '$visible',last_modified = '$datetime',integrado = '$integrado' WHERE id = '$id'";
