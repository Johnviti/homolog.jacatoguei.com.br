	...
	<ul class="nav navbar-nav">
		...
		<li class="dropdown">
			...
			<ul class="dropdown-menu">
				...
				<li><a href="<?php panel_url(); ?>/produtos/importar/"><i class="lni lni-circle-plus"></i> Importar Excel</a></li>
			</ul>
		</li>
		...
		<li class="active"><a href="https://api.whatsapp.com/send?text=Aderi a *jacatalogueigueiguei* para ter uma loja virtual para minha empresa integrado com o WhatsApp, cadastre-se vc tb e teste por 15 dias sem compromisso, venha conhecer essa ferramenta maravilhosa. Eu estou gostando muito, *clique no link:* https://jacataloguei.com.br/comece/?afiliado=<?php echo user_info('email'); ?>">Indique 1 amigo</a></li>
		<!--
